...
MAIL_FROM = 'andrewrewand.test@yandex.ru', // от какого email будет отправляться письмо
MAIL_FROM_NAME = 'Comofprof.ru', // от какого имени будет отправляться письмо
MAIL_SUBJECT = 'Сообщение с сайта', // тема письма
MAIL_ADDRESS = 'andrewrewand.test@yandex.ru', // кому необходимо отправить письмо
...
MAIL_SMTP_USERNAME = 'andrewrewand.test@yandex.ru', // здесь нужно указать email пользователя с которого будет отправлять письмо (SMTP-пользователь)
MAIL_SMTP_PASSWORD = 'ed76699667de'; // здесь нужно указать пароль от почты (SMTP-пароль)
